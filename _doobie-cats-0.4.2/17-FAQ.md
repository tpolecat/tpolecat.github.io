...
<console>:37: error: Could not find or construct Param[shapeless.::[String,shapeless.::[java.util.UUID,shapeless.HNil]]].
...
```
scala> Meta[String]
res11: doobie.util.meta.Meta[String] = doobie.util.meta$Meta$$anon$3@c059010

scala> Meta[UUID]
<console>:37: error: Could not find an instance of Meta[java.util.UUID]; you can construct one based on a primitive instance via `xmap`.
       Meta[UUID]
           ^
```
...
```scala
scala> Meta[UUID]
res13: doobie.util.meta.Meta[java.util.UUID] = doobie.util.meta$Meta$$anon$4@3184d8a0

scala> Param[String :: UUID :: HNil]
res14: doobie.util.param.Param[shapeless.::[String,shapeless.::[java.util.UUID,shapeless.HNil]]] = Param(doobie.util.composite$LowerPriorityComposite$$anon$10@6a678db2)
...
<console>:40: error: Could not find or construct Composite[State].
...
<console>:38: error: Could not find or construct Composite[java.awt.geom.Point2D.Double].
...
```scala
scala> sql"…".query[State]
res17: doobie.util.query.Query0[State] = doobie.util.query$Query$$anon$7@7611f9d1
```
