...
scala> (sql"select code, name, population, gnp from country"
     ...
     |   .process.take(5).quick.run)
<console>:37: warning: method run in class Task is deprecated: use unsafePerformSync
         .process.take(5).quick.run)
                                ^
...
scala> (sql"select code, name, population, gnp from country"
     ...
     |    .quick.run)
<console>:40: warning: method run in class Task is deprecated: use unsafePerformSync
          .quick.run)
                 ^
